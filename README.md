...
| postgres    | :5432             | —                 | metadata, audit, users              |
| redis       | :6379             | —                 | sessions, rate-limit                |
| mailserver  | :25/143/587       | —                 | Postfix + Dovecot (внутренний доступ)|
| radicale    | :5232             | —                 | CalDAV + CardDAV                    |

> Для production добавьте 443 в edge с TLS-сертификатом (Phase 3).
